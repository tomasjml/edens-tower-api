...
public class GameController {
    ...
    public ResponseEntity postGame(@RequestParam String username, @RequestParam String difficulty, @RequestParam boolean fullScreen, @RequestParam boolean autoSave,
                                   ...
                                   @RequestParam String saveData, @RequestParam String saveSlotstr, @RequestParam long highScore){
        ...
        if(oldGame.isEmpty()){
            ...
            if(cantSaves < 4){
                Game game = new Game(
                        ...
                        speed, luck, totalKills,totalDeaths, highScore
                );
            ...
            Game newGame = new Game(
                    ...
                    totalKills, totalDeaths, highScore
            );
